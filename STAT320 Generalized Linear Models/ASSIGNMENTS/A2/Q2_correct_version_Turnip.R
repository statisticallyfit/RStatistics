...
# Variation among leaves (NOT the RESIDUAL VARIANCE COMPONENT: )
...
## RESIDUAL VARIANCE: (variation among replicates): since the boxplots for each leaf 
# within turnip are narrow, this means there is little variation in calcium content among
...
# and the id of the number goes up to number of levels in the y ~
dotplot(leaves ~ ca | plants, data=turnipData, pch=c(1,1,1,1,1),
